...
return [{
  json: {
    ...
    word_count: Number(wordCount || 2000),
    seo_score: Number(seoGeo.seo_score || 85),
    geo_score: Number(seoGeo.geo_score || 82),
    overall_score: Number(seoGeo.overall_score || 84),
    status: 'Completed',
    deliverable_preview: String(articleBody ? articleBody.substring(0, 500) : 'Full article generated')
  }
}];
`;
...
async function main() {
  ...
  console.log('✅ Step 5A updated with dual direct/body input support!');
}
